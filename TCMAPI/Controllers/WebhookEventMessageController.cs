...
namespace TCMAPI.Controllers
{
    ...
    public class WebhookEventMessageController : ControllerBase
    {
        ...
        public IActionResult Post([FromBody] RootEventMessageModel val)
        {
            ...
            switch (messageType)
            {
                case "message":
                    ...
                    {
                        result = PushFlexMessageQToUser(userId);
                    }
                ...
                case "postback":
                    ...
                    {
                        result = PushFlexMessageCToUser(userId);
                    }
                    break;
                case "things":
                    break;
        ...
        protected string PushFlexMessageQToUser(string userId)
        {
            string result = "Ok";
        ...
        protected string PushFlexMessageCToUser(string userId)
        {
            string result = "Ok";
